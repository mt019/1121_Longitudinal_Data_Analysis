...
\usepackage[a4paper, margin=.95in,             
left=0.95in,
right=0.95in
]{geometry}
...
\fancyhead[C]{Longitudinal Data Analysis\quad Final Paper Review\quad  R10A21126\quad  WANG YIFAN\quad   \today}
...
\setlist[itemize]{itemsep=0mm, parsep=0mm} % Setting itemize spacing globally
